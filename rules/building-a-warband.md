...
1.  <span id="A5_Rules_Doppelseiten-2.xhtml__idTextAnchor002"></span>Suggested Warband Sizes
...
A warband that includes models from more than one faction is a Mercenary warband. Every model in a Mercenary warband costs 5 points more; this is not a trait and takes no trait slot.

Mercenary warbands may only use the Common Fate Modifier and the lores Lesser Magic and Minor Rites.
...
1.  Arcane and Divine lores

Choose one Arcane Lore and one Divine Lore. Each Lore is available only if your warband includes at least one model with the matching trait, Arcane or Divine. Lores do not cost additional points. Mercenary warbands may only choose Lesser Magic and Minor Rites.

1.  Warband Composition
...
![](media/image/Fate_Modifier_card_csv_74x105_Seite_01.png)

## <span id="A5_Rules_Doppelseiten-2.xhtml__idTextAnchor003"></span>Fate Modifier
...
![](media/image/Model_card_csv_74x105_-_2025_Seite_07.png)
...
Displayed in the corner, this is the cost in points (PTS) to include the model in your warband. Total warband points must not exceed the agreed point limit.
...
Vitality (VIT)\
Health points of a model. At 0 the model is Defeated.

1.  Flavor Text

Descriptive text providing background, theme or personality. This section is optional and has no in game effect.

- This space can be used to place dice to track remaining Vitality during the game.
...
Lists unique traits or abilities the model possesses. These may grant access to special actions, provide immunities, or modify core mechanics. A model can have no more than 5 Traits in total. Traits granted by Body Type, Tier, Armor and equipment count toward this limit.
...
![](media/image/Fate_Modifier_card_csv_74x105_Seite_03.png)

<span id="A5_Rules_Doppelseiten-3.xhtml"></span>
